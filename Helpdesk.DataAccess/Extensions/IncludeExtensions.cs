...
public static class IncludeExtensions
{
  ...
  private static readonly MethodInfo IncludeAfterCollectionMethodInfo = typeof(EntityFrameworkQueryableExtensions)
    .GetTypeInfo()
    .GetDeclaredMethods(nameof(EntityFrameworkQueryableExtensions.ThenInclude)).Single(mi =>
  ...
  public static IQueryable Include(this IQueryable source, Type entityType, params string[] propertyPaths)
  {
    object query = source;
